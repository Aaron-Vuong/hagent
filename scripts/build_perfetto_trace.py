...
def parse_arguments() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        '-i', '--input-dir', type=str, default='.', help='Scans this directory for YAML files generated by Steps.'
    )
    parser.add_argument(
        '--asynchronous', action='store_true', help='Builds a Perfetto trace that displays Steps as parallel as possible.'
    )
    parser.add_argument('-o', '--output-file', type=str, default='perfetto.json', help='Name of the output Perfetto Trace.')
    parser.add_argument(
